...
DECLARE_INTERFACE_IID_(IDXCoreAdapterList, IUnknown, "526c7776-40e9-459b-b711-f32ad76dfc28")
{
    ...
    STDMETHOD(GetAdapter) (THIS_ uint32_t index, REFIID riid, _Outptr_ void **ppv) PURE;
    STDMETHOD_(uint32_t, GetAdapterCount) (THIS) PURE;
    STDMETHOD_(BOOL, IsStale) (THIS) PURE;
    STDMETHOD(GetFactory) (THIS_ REFIID riid, _Outptr_ void **ppv) PURE;
...
DECLARE_INTERFACE_IID_(IDXCoreAdapterFactory, IUnknown, "78ee5945-c36e-4b13-a669-005dd11c0f06")
{
    ...
    STDMETHOD(CreateAdapterList) (THIS_ uint32_t num_attributes, const GUID *filter_attributes, REFIID riid, _Outptr_ void **ppv) PURE;
    STDMETHOD(GetAdapterByLuid) (THIS_ REFLUID adapter_luid, REFIID riid, _Outptr_ void **ppv) PURE;
